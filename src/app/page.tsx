  ...
  return (
    <div className="bg-white text-gray-800 font-sans">
          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              },
              {
                ...
                title: "Essential Offline Access",
      ...
      <section className="py-20 bg-gray-100 text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <div className="mt-4 font-semibold text-purple-700">— Jane, Kiambu Farmer, Kenya</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-purple-600 text-white text-center">
        <h3 className="text-2xl font-bold">Ready to streamline your farm operations?</h3>
        <p className="mt-2 text-lg">Download Turuke today and experience simplified poultry management.</p>
        <a
          href="https://play.google.com/store/apps/details?id=com.example.turuke"
          target="_blank"
          rel="noopener noreferrer"
